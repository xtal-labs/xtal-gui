...
const variantStyles = {
  ...
  stem: "border-emerald-500/30 bg-linear-to-br from-emerald-500/20 via-green-500/15 to-teal-500/10",
  leaf: "border-amber-500/30 bg-linear-to-br from-amber-600/25 via-orange-400/15 via-60% to-yellow-600/10",
  stake: "border-violet-500/30 bg-linear-to-br from-violet-500/20 via-purple-500/15 to-fuchsia-500/10",
  unstake: "border-sky-500/30 bg-linear-to-br from-sky-500/20 via-cyan-500/15 to-blue-500/10",
};
...
function ToastItem({ toast }: { toast: Toast }) {
  ...
  const getStyles = () => {
    if (isFruitToast) {
      ...
      return {
        container: cn("bg-linear-to-br", fruitColors.bg, fruitColors.border, "shadow-md", fruitColors.glow),
