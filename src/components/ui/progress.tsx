      ...
      >
        <ProgressPrimitive.Indicator
          className={cn(
            ...
            geometric ? "chamfered-sm" : "rounded-full",
            variant === "default" && [
              "bg-linear-to-r from-primary via-crystal-facet-light to-primary",
            ],
            variant === "success" && "bg-linear-to-r from-success via-emerald-400 to-success",
            variant === "warning" && "bg-linear-to-r from-warning via-amber-400 to-warning",
            variant === "info" && "bg-linear-to-r from-info via-blue-400 to-info",
            indicatorClassName
          )}
